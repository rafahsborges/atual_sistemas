...
class FillPermissionsForRemessaBoleto extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRemessaBoleto constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.remessa-boleto',
            'admin.remessa-boleto.index',
            'admin.remessa-boleto.create',
            'admin.remessa-boleto.show',
            'admin.remessa-boleto.edit',
            'admin.remessa-boleto.delete',
            'admin.remessa-boleto.bulk-delete',
        ]);
