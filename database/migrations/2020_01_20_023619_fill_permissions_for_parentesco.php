...
class FillPermissionsForParentesco extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForParentesco constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.parentesco',
            'admin.parentesco.index',
            'admin.parentesco.create',
            'admin.parentesco.show',
            'admin.parentesco.edit',
            'admin.parentesco.delete',
            'admin.parentesco.bulk-delete',
        ]);
