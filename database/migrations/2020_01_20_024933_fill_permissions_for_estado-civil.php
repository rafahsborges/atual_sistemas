...
class FillPermissionsForEstadoCivil extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEstadoCivil constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.estado-civil',
            'admin.estado-civil.index',
            'admin.estado-civil.create',
            'admin.estado-civil.show',
            'admin.estado-civil.edit',
            'admin.estado-civil.delete',
            'admin.estado-civil.bulk-delete',
        ]);
