...
class FillPermissionsForContrato extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForContrato constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.contrato',
            'admin.contrato.index',
            'admin.contrato.create',
            'admin.contrato.show',
            'admin.contrato.edit',
            'admin.contrato.delete',
            'admin.contrato.bulk-delete',
        ]);
