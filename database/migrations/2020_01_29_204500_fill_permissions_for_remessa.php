...
class FillPermissionsForRemessa extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRemessa constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.remessa',
            'admin.remessa.index',
            'admin.remessa.create',
            'admin.remessa.show',
            'admin.remessa.edit',
            'admin.remessa.delete',
            'admin.remessa.bulk-delete',
        ]);
