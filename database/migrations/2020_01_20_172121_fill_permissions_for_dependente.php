...
class FillPermissionsForDependente extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDependente constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.dependente',
            'admin.dependente.index',
            'admin.dependente.create',
            'admin.dependente.show',
            'admin.dependente.edit',
            'admin.dependente.delete',
            'admin.dependente.bulk-delete',
        ]);
