                            ...
                            <div class="col-md-8">
                                <div class="form-group row align-items-center"
                                    ...
                                    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                                        <input type="text" v-model="form.name" v-validate="''" @input="validate($event)"
                                               class="form-control"
                                               :class="{'form-control-danger': errors.has('name'), 'form-control-success': fields.name && fields.name.valid}"
                                               id="name" name="name"
                                               placeholder="{{ trans('admin.admin-user.columns.name') }}">
                                    ...
                                    <div class="form-group row"
                                        ...
                                        <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-9'">
                                            <input class="form-check-input" id="is_admin" type="checkbox"
                                                   v-model="form.is_admin" v-validate="''" data-vv-name="is_admin"
                                                   name="is_admin_fake_element">
                                            <label class="form-check-label" for="is_admin">
                                                {{ trans('admin.admin-user.columns.is_admin') }}
                                            </label>
                                            <input type="hidden" name="is_admin" :value="form.is_admin">
                                            <div v-if="errors.has('is_admin')" class="form-control-feedback form-text"
                                                 v-cloak>@{{ errors.first('is_admin') }}
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="form-group row align-items-center"
                                    ...
                                    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                                        ...
                                        <div v-if="errors.has('language')" class="form-control-feedback form-text"
                                             v-cloak>@{{ errors.first('language') }}
                                        </div>
                                    </div>
                                </div>
