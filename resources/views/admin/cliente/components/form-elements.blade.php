...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            ...
            placeholder="{{ __('Estado Civil') }}">
        </multiselect>
        <input type="text" v-model="form.id_estado_civil" v-validate="''" @input="validate($event)" class="form-control"
...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.id_cliente_responsavel" v-validate="'integer'" @input="validate($event)"
               class="form-control"
...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.local_trabalho" v-validate="''" @input="validate($event)" class="form-control"
...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.insc_municipal" v-validate="''" @input="validate($event)" class="form-control"
