<div class="form-group row align-items-center"
    ...
    <label for="id_cliente" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.contrato.columns.id_cliente') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            ...
            track-by="id"
            label="nome"
            tag-placeholder="{{ trans('admin.contrato.columns.id_cliente') }}"
            placeholder="{{ trans('admin.contrato.columns.id_cliente') }}">
        </multiselect>
...
<div class="form-group row align-items-center"
     :class="{'has-danger': errors.has('id_plano'), 'has-success': fields.id_plano && fields.id_plano.valid }">
    <label for="id_plano" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.contrato.columns.id_plano') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            v-model="form.plano"
            :options="planos"
            ...
            track-by="id"
            label="nome"
            tag-placeholder="{{ trans('admin.contrato.columns.id_plano') }}"
            placeholder="{{ trans('admin.contrato.columns.id_plano') }}">
        </multiselect>
        <div v-if="errors.has('id_plano')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('id_plano')
            }}
        </div>
    </div>
</div>
...
<div class="form-group row align-items-center"
    ...
    <label for="multa" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.contrato.columns.multa') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-money="percent" :maxlength="7" v-model="form.multa" v-validate="''"
               ...
               id="multa" name="multa" placeholder="{{ trans('admin.contrato.columns.multa') }}">
...
<div class="form-group row align-items-center"
    ...
    <label for="juros" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.contrato.columns.juros') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-money="percent" :maxlength="7" v-model="form.juros" v-validate="''"
               ...
               id="juros" name="juros" placeholder="{{ trans('admin.contrato.columns.juros') }}">
...
<div class="form-group row align-items-center"
    ...
    <label for="desconto" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.contrato.columns.desconto') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-money="money" :maxlength="17" v-model="form.desconto" v-validate="''" @input="validate($event)"
               ...
               id="desconto" name="desconto" placeholder="{{ trans('admin.contrato.columns.desconto') }}">
...
<div class="form-check row"
     :class="{'has-danger': errors.has('plano_funeral'), 'has-success': fields.plano_funeral && fields.plano_funeral.valid }">
    <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
        <input class="form-check-input" id="plano_funeral" type="checkbox" v-model="form.plano_funeral" v-validate="''"
               data-vv-name="plano_funeral" name="plano_funeral_fake_element">
        ...
        <div v-if="errors.has('plano_funeral')" class="form-control-feedback form-text" v-cloak>@{{
            errors.first('plano_funeral') }}
        </div>
    </div>
</div>

<div class="form-group row align-items-center"
     :class="{'has-danger': errors.has('tipo_pagamento'), 'has-success': fields.tipo_pagamento && fields.tipo_pagamento.valid }">
    <label for="tipo_pagamento" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.contrato.columns.tipo_pagamento') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            ...
            track-by="id"
            label="nome"
            tag-placeholder="{{ trans('admin.contrato.columns.tipo_pagamento') }}"
            placeholder="{{ trans('admin.contrato.columns.tipo_pagamento') }}">
        </multiselect>
        <div v-if="errors.has('tipo_pagamento')" class="form-control-feedback form-text" v-cloak>@{{
...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            ...
            track-by="id"
            label="nome"
            tag-placeholder="{{ trans('admin.contrato.columns.id_conta') }}"
            placeholder="{{ trans('admin.contrato.columns.id_conta') }}">
        </multiselect>
        <div v-if="errors.has('id_conta')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('id_conta')
            }}
        </div>
    </div>
</div>
...
<div class="form-group row align-items-center"
     :class="{'has-danger': errors.has('data_assinatura'), 'has-success': fields.data_assinatura && fields.data_assinatura.valid }">
    <label for="data_assinatura" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.contrato.columns.data_assinatura') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
            <datetime v-model="form.data_assinatura" :config="datePickerConfig"
                      v-validate="'required|date_format:yyyy-MM-dd HH:mm:ss'" class="flatpickr"
                      :class="{'form-control-danger': errors.has('data_assinatura'), 'form-control-success': fields.data_assinatura && fields.data_assinatura.valid}"
                      id="data_assinatura" name="data_assinatura"
                      placeholder="{{ trans('brackets/admin-ui::admin.forms.select_a_date') }}"></datetime>
        </div>
        <div v-if="errors.has('data_assinatura')" class="form-control-feedback form-text" v-cloak>@{{
            errors.first('data_assinatura') }}
        </div>
    </div>
</div>
...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
            <datetime v-model="form.primeira_parcela" :config="datePickerConfig"
                      v-validate="'required|date_format:yyyy-MM-dd HH:mm:ss'" class="flatpickr"
                      :class="{'form-control-danger': errors.has('primeira_parcela'), 'form-control-success': fields.primeira_parcela && fields.primeira_parcela.valid}"
                      id="primeira_parcela" name="primeira_parcela"
                      placeholder="{{ trans('brackets/admin-ui::admin.forms.select_a_date') }}"></datetime>
        </div>
        <div v-if="errors.has('primeira_parcela')" class="form-control-feedback form-text" v-cloak>@{{
            errors.first('primeira_parcela') }}
        </div>
    </div>
</div>

<div class="form-group row align-items-center"
     :class="{'has-danger': errors.has('qtd_parcelas'), 'has-success': fields.qtd_parcelas && fields.qtd_parcelas.valid }">
    <label for="qtd_parcelas" class="col-form-label text-md-right"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        ...
        <div v-if="errors.has('qtd_parcelas')" class="form-control-feedback form-text" v-cloak>@{{
            errors.first('qtd_parcelas') }}
        </div>
    </div>
</div>

<div class="form-group row align-items-center"
     :class="{'has-danger': errors.has('validade_contrato'), 'has-success': fields.validade_contrato && fields.validade_contrato.valid }">
    <label for="validade_contrato" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.contrato.columns.validade_contrato') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
        ...
        <div v-if="errors.has('validade_contrato')" class="form-control-feedback form-text" v-cloak>@{{
            errors.first('validade_contrato') }}
        </div>
    </div>
</div>

<div class="form-group row align-items-center"
     :class="{'has-danger': errors.has('ultima_parcela'), 'has-success': fields.ultima_parcela && fields.ultima_parcela.valid }">
    <label for="ultima_parcela" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.contrato.columns.ultima_parcela') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
