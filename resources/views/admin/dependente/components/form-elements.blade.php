<div class="form-group row align-items-center"
    ...
    <label for="nome" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.dependente.columns.nome') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.nome" v-validate="'required'" @input="validate($event)" class="form-control"
               ...
               id="nome" name="nome" placeholder="{{ trans('admin.dependente.columns.nome') }}">
...
<div class="form-group row align-items-center"
    ...
    <label for="nascimento" class="col-form-label text-md-right"
           :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.dependente.columns.nascimento') }}</label>
...
<div class="form-group row align-items-center"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            ...
            track-by="id"
            label="nome"
            tag-placeholder="{{ __('Select Cliente') }}"
            placeholder="{{ trans('admin.dependente.columns.id_cliente') }}">
        </multiselect>
...
<div class="form-group row align-items-center"
     :class="{'has-danger': errors.has('id_parentesco'), 'has-success': fields.id_parentesco && fields.id_parentesco.valid }">
    <label for="id_parentesco" class="col-form-label text-md-right"
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            ...
            track-by="id"
            label="nome"
            tag-placeholder="{{ __('Select Parentesco') }}"
            placeholder="{{ trans('admin.dependente.columns.id_parentesco') }}">
        </multiselect>
